class Drawflow {
            ...
            if (ele_last.classList[0] === 'input' || (this.force_first_input && (ele_last.closest(".drawflow_content_node") != null || ele_last.classList[0] === 'drawflow-node'))) {
                ...
                if (output_id !== input_id && input_class !== false) {
                    ...
                    if (this.container.querySelectorAll('.connection.node_in_' + input_id + '.node_out_' + output_id + '.' + output_class + '.' + input_class).length === 0) {
                        ...
                        this.dispatch('connectionCancel', { error_id: 0, error_message: "Connection exist" });
                    ...
                    this.dispatch('connectionCancel', { error_id: 2, error_message: "Should not connect out to the same node's in" });
                    this.connection_ele.remove();
                    this.connection_ele = null;
                }
                ...
                // Remove Connection;
                this.dispatch('connectionCancel', { error_id: 1, error_message: "It's not a node's in" });
                this.connection_ele.remove();
                this.connection_ele = null;
            }
        }
    ...
    setConnectionName(id_output, id_input, output_class, input_class, event_name){
            ...
            if (exists > -1) {
                ...
                if (exist === false) {
                    ...
                    if (this.module === nodeOneModule) {
                        ...
                        var pathId = 'path' + id_output + id_input + this.uuid;
                        ...
                        textPath.textContent = event_name;
    ...
    addConnection(id_output, id_input, output_class, input_class, event_name) {
        var nodeOneModule = this.getModuleFromNodeId(id_output);
        var nodeTwoModule = this.getModuleFromNodeId(id_input);
        if (nodeOneModule === nodeTwoModule) {
    ...
    dblclick(e) {
        ...
        if (e.target.classList[0] === 'main-path') {
            const listclassConnection = this.connection_selected.parentElement.classList;
            this.dispatch('connectionDblClick', { output_id: listclassConnection[2].slice(14), input_id: listclassConnection[1].slice(13), output_class: listclassConnection[3], input_class: listclassConnection[4] });
        }

        if (e.target.closest(".drawflow_content_node") != null) {
            var selected = e.target.closest(".drawflow_content_node").parentElement;
            if (selected.classList[0] === 'drawflow-node') {
                this.dispatch('nodeDblClick', this.node_selected.id.slice(5));
            }
        }
    }
    ...
    addNodeById(id, name, num_in, num_out, ele_pos_x, ele_pos_y, classoverride, data, html, typenode = false) {
        var newNodeId = id;
    ...
    updateNodeDataFromId(id, data, name) {
        var moduleName = this.getModuleFromNodeId(id)
        this.drawflow.drawflow[moduleName].data[id].name = name;
...
class drawflowP {
    constructor(e, t, o)
    {
        this.mousedown =
            ...
            {
                view: window, bubbles: !0, cancelable: !1
            }),
            this.mouseup =
        ...
        this.editor = new Drawflow(i),
            this.editor.start(),
            this.editor.editor_mode = o,
            this.editor.on("nodeCreated",
                (function (e)
                {
                    t.invokeMethodAsync("OnNodeCreated", e.toString())
                })),
            this.editor.on("nodeRemoved",
                (function (e)
                {
                    t.invokeMethodAsync("OnNodeRemoved", e.toString())
                })),
            this.editor.on("nodeSelected",
                (function (e)
                {
                    t.invokeMethodAsync("OnNodeSelected", e.toString())
                })),
            this.editor.on("nodeUnselected",
                (function (e)
                {
                    t.invokeMethodAsync("OnNodeUnselected", e.toString())
                })),
            this.editor.on("connectionSelected",
                (function (e) {
                    t.invokeMethodAsync("OnConnectionSelected", e.output_id.toString(), e.input_id.toString(), e.output_class.toString(), e.input_class.toString())
                })),
            this.editor.on("connectionUnselected",
                (function (e) {
                    t.invokeMethodAsync("OnConnectionUnselected")
                })), 
            this.editor.on("nodeDataChanged",
                (function (e)
                {
                    t.invokeMethodAsync("OnNodeDataChanged", e.toString())
                })),
            this.editor.on("import",
                (function (e) {
                    t.invokeMethodAsync("OnImport")
                })),
            this.editor.on("connectionCreated",
                (function (e) {
                    t.invokeMethodAsync("OnConnectionCreated", e.output_id.toString(), e.input_id.toString(), e.output_class.toString(), e.input_class.toString())
                })),
            this.editor.on("connectionRemoved",
                (function (e) {
                    t.invokeMethodAsync("OnConnectionRemoved", e.output_id.toString(), e.input_id.toString(), e.output_class.toString(), e.input_class.toString())
                })),
            this.editor.on("connectionCancel",
                (function (e) {
                    t.invokeMethodAsync("OnConnectionCancel", e.error_id, e.error_message)
                })),
            this.editor.on("connectionStart",
                (function (e) {
                    t.invokeMethodAsync("OnConnectionStart", e.output_id.toString(), e.output_class.toString())
                })),
            this.editor.on("nodeMoved",
                (function (e) {
                    t.invokeMethodAsync("OnNodeMoved", e.toString())
                })),
            this.editor.on("connectionDblClick",
                (function (e) {
                    t.invokeMethodAsync("OnConnectionDblClick", e.output_id.toString(), e.input_id.toString(), e.output_class.toString(), e.input_class.toString())
                })),
            this.editor.on("nodeDblClick",
                (function (e) {
                    t.invokeMethodAsync("OnNodeDblClick", e)
                })) 
    }
    setMode(e)
    {
        this.editor.editor_mode = e
    }
    addNode(e, t, o, i, d, n, r, s, a = {}, h) {
        //if ("fixed" == this.editor.editor_mode) return null;
        //const c = i
        ...
        //        * (this.editor.precanvas.clientHeight / (this.editor.precanvas.clientHeight * this.editor.zoom))
        //        - r;
        return this.editor.addNode(e, t, o, i, d, s, a, h, !1).toString()
    }
    addNodeById(id, name, num_in, num_out, ele_pos_x, ele_pos_y, n, r, classoverride, data = {}, html) {
        //if ("fixed" == this.editor.editor_mode) return null;
        //const c = i
        //    * (this.editor.precanvas.clientWidth / (this.editor.precanvas.clientWidth * this.editor.zoom))
        //    - this.editor.precanvas.getBoundingClientRect().x
        ...
        //        * (this.editor.precanvas.clientHeight / (this.editor.precanvas.clientHeight * this.editor.zoom))
        //        - r;
        return this.editor.addNodeById(id, name, num_in, num_out, ele_pos_x, ele_pos_y, classoverride, data, html, !1).toString()
    }
    dragNode(e, t, o, i, d, n, r, s, a = {}, h) {
        if ("fixed" == this.editor.editor_mode) return null;
        const c = i
            * (this.editor.precanvas.clientWidth / (this.editor.precanvas.clientWidth * this.editor.zoom))
            - this.editor.precanvas.getBoundingClientRect().x
            * (this.editor.precanvas.clientWidth / (this.editor.precanvas.clientWidth * this.editor.zoom))
            ...
            l = d
                ...
                * (this.editor.precanvas.clientHeight / (this.editor.precanvas.clientHeight * this.editor.zoom))
                - r;
        return this.editor.addNode(e, t, o, c, l, s, a, h, !1).toString()
    }
    addConnection(id_output, id_input, output_class, input_class, eventName)
    {
        this.editor.addConnection(id_output, id_input, output_class, input_class, eventName)
    }
    removeSingleConnection(id_output, id_input, output_class, input_class)
    {
        this.editor.removeSingleConnection(id_output, id_input, output_class, input_class)
    }
    removeNodeId(e)
    {
        this.editor.removeNodeId(e)
    }
    getNodeFromId(e)
    {
        const t = this.editor.getNodeFromId(e); return t.id = t.id.toString(), t
    }
    getNodesFromName(e) {
        const t = this.editor.getNodesFromName(e); return t
    }
    updateNodeDataFromId(e, t, n)
    {
        this.editor.updateNodeDataFromId(e, t, n), this.editor.dispatch("nodeDataChanged", e)
    }
    updateNodeHtml(e, t)
    {
        this.editor.container.querySelector(`#node-${e} .drawflow_content_node`).innerHTML = t;
        //this.editor.drawflow.drawflow.Home.data[e].html = t
    }
    addNodeInput(e)
    {
        this.editor.addNodeInput(e)
    }
    addNodeOutput(e)
    {
        this.editor.addNodeOutput(e)
    }
    removeNodeInput(e, t)
    {
        this.editor.removeNodeInput(e, t)
    }
    removeNodeOutput(e, t)
    {
        this.editor.removeNodeOutput(e, t)
    }
    updateConnectionNodes(e)
    {
        this.editor.updateConnectionNodes(e)
    }
    removeConnectionNodeId(e)
    {
        this.editor.removeConnectionNodeId(e)
    }
    setConnectionName(id_output, id_input, output_class, input_class, eventName)
    {
        this.editor.setConnectionName(id_output, id_input, output_class, input_class, eventName)
    }
    clear()
    {
        this.editor.clear()
    ...
    export(e = !1)
    {
        const t = this.editor.export(); return JSON.stringify(t, null, e ? 2 : null)
    }
    import(e)
    {
        const t = JSON.parse(e); this.editor.import(t)
    }
    focusNode(e)
    {
        this.editor.container.querySelector(`#node-${e} .drawflow_content_node`).dispatchEvent(this.mousedown), this.editor.container.querySelector(`#node-${e} .drawflow_content_node`).dispatchEvent(this.mouseup)
    }
    centerNode(e, t)
    {
        const o = this.editor.container.getElementById(`node-${e}`), i = this.editor.drawflow.drawflow.Home.data[e].pos_x, d = this.editor.drawflow.drawflow.Home.data[e].pos_y, n = o.clientWidth, r = o.clientHeight, s = this.editor.precanvas.clientWidth / 2 - i - n / 2, a = this.editor.precanvas.clientHeight / 2 - d - r / 2, h = this.editor.zoom; if (this.setTranslate(s, a, h), t) { const e = 50, t = 500; o.style.transition = `all ${t / 1e3}s ease 0s`, window.setTimeout((() => { o.style.transform = "scale(1.1)" }), e), window.setTimeout((() => { o.style.transform = "scale(1.0)" }), e + t), window.setTimeout((() => { o.style.transition = "", o.style.transform = "" }), e + 2 * t) } this.focusNode(e)
    }
    setTranslate(e, t, o)
    {
        this.editor.canvas_x = e, this.editor.canvas_y = t;
        let i = o;
        this.editor.zoom = 1,
...
function drawflowProxyInit(t, o, i = "edit")
{
    return new drawflowP(t, o, i)
}
export
{
    drawflowProxyInit as init
};
//# sourceMappingURL=drawflow-export.js.map
